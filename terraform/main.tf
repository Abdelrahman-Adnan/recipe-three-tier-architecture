# ===========================================================================
# Manara Recipes - Terraform Configuration
# ===========================================================================
# This Terraform configuration deploys the Manara Recipes demonstration application
# on AWS using a three-tier architecture (presentation, application, data).
...
variable "app_name" {
  ...
  type        = string
  default     = "recipe-three-tier-architecture"
}
