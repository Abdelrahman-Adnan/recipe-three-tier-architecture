  ...
  return (
    <Container maxWidth="lg">
      ...
      <Alert severity="info" sx={{ mb: 4 }}>
        ...
        Special thanks to the instructors and mentors who supported this AWS Solutions Architect Associate learning path. Their guidance helped shape the project's learning goals and implementation.
      </Alert>
      ...
      >
        <Chip
          icon={<SchoolIcon />}
          label="Recipe Three-Tier Architecture — SAA Project"
          color="primary"
          variant="filled"
          sx={{ 
            mb: 3, 
